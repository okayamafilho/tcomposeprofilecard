...
//    UserProfile("Toshiaki Okayama Filho", status = true, R.drawable.profile),
//    UserProfile("Maria Rosane", status = false, R.drawable.ic_launcher_background),
//    UserProfile("Zeni", status = true, R.drawable.profile),
//    UserProfile("Toshiaki Okayama Filho", status = true, R.drawable.profile),
//    UserProfile("Maria Rosane", status = false, R.drawable.ic_launcher_background),
//    UserProfile("Zeni", status = true, R.drawable.profile),
//    UserProfile("Toshiaki Okayama Filho", status = true, R.drawable.profile),
